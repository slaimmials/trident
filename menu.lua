...
local function LEDJ_fake_script() -- Close.LocalScript 
...
coroutine.wrap(LEDJ_fake_script)()
local function WCNDCP_fake_script() -- Main.MoveScript 
...
coroutine.wrap(WCNDCP_fake_script)()
local function BJDMCLS_fake_script() -- PlayersESP.LocalScript 
...
coroutine.wrap(BJDMCLS_fake_script)()
local function GMHILZV_fake_script() -- Visuals_2.LocalScript 
...
coroutine.wrap(GMHILZV_fake_script)()
local function CBIM_fake_script() -- Player.LocalScript 
...
coroutine.wrap(CBIM_fake_script)()
local function UNUWK_fake_script() -- Combat.LocalScript 
...
coroutine.wrap(UNUWK_fake_script)()
