				...
				for _,v in pairs(workspace:GetDescendants()) do
					if v.Name == "Nametag" then
						if not v.Parent.Parent:FindFirstChild("NicknameEsp") and (v:FindFirstChild("tag").Text ~= game.Players.LocalPlayer.Name) then
							...
							if v:FindFirstChild("tag").Text ~= "" and v:FindFirstChild("tag").Text ~= nil and v:FindFirstChild("tag").Text ~= " " then
								v.Parent.Parent:FindFirstChild("NicknameEsp").NName.Text = v:FindFirstChild("tag").Text
							else
								v.Parent.Parent:FindFirstChild("NicknameEsp").NName.Text = "player"
							end
						end
					end
				end
